...
#PBS -j oe
#PBS -N HybPhyloMaker0e_create_test_dataset
#PBS -m abe
...
#$ -cwd
#$ -j y
#$ -N HybPhyloMaker0e_create_test_dataset
#$ -o HybPhyloMaker0e_create_test_dataset.log

# ********************************************************************************
# *    HybPhyloMaker - Pipeline for Hyb-Seq data processing and tree building    *
# *                  https://github.com/tomas-fer/HybPhyloMaker                  *
# *                       Script 0e - Preapare test dataset                      *
# *                                   v.1.8.0                                    *
...
if [[ $PBS_O_HOST == *".cz" ]]; then
	echo -e "\nHybPhyloMaker0e is running on MetaCentrum...\n"
	...
	echo -e "\nHybPhyloMaker0e is running on Hydra...\n"
	#settings for Hydra
	...
	echo -e "\nHybPhyloMaker0e is running locally...\n"
...
if [[ ! $location == "1" ]]; then
	if [ "$(ls -A ../workdir0e)" ]; then
		echo -e "Directory 'workdir0e' already exists and is not empty. Delete it or rename before running this script again. Exiting...\n"
		rm -d ../workdir0e/ 2>/dev/null
		exit 3
	fi
fi
...
echo -e "\nScript HybPhyloMaker0e finished...\n"
