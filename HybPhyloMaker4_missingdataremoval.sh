...
#PBS -l mem=12gb
#PBS -l scratch=4gb
#PBS -N HybPhyloMaker4_missingdata_handling
#PBS -m abe
...
#$ -cwd
#$ -j y
#$ -N HybPhyloMaker4_missingdata_handling
#$ -o HybPhyloMaker4_missingdata_handling.log
...
echo -e "Script HybPhyloMaker4 is running...\n"
