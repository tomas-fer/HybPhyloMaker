...
if [[ $location == "1" ]]; then
	raxmlHPC-PTHREADS -T 12 -f a -s MRLmatrix_${MISSINGPERCENT}_${SPECIESPRESENCE}.phylip -n MRLresult -m BINCAT -p 1234 -x 1234 -N 100
elif [[ $location == "2" ]]; then
	raxmlHPC-PTHREADS-SSE3 -T 12 -f a -s MRLmatrix_${MISSINGPERCENT}_${SPECIESPRESENCE}.phylip -n MRLresult -m BINCAT -p 1234 -x 1234 -N 100
else
	raxmlHPC -T 12 -f a -s MRLmatrix_${MISSINGPERCENT}_${SPECIESPRESENCE}.phylip -n MRLresult -m BINCAT -p 1234 -x 1234 -N 100
fi
